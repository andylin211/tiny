...
void fuzz_with_random_data(HANDLE device_handle, unsigned long ioctl_code, fuzz_notify_func notify, void* notify_data, int percent_min, int percent_max)
{
	int i = 0, j = 0;
	int inlen = 0, oulen = 0;
	int retlen = 0;
...
void fuzz_overflow(HANDLE device_handle, unsigned long ioctl_code, fuzz_notify_func notify, void* notify_data, int percent_min, int percent_max)
{
	int i = 0;
	int retlen = 0;
	int status = 0;
...
void fuzz_with_predefined_data(HANDLE device_handle, unsigned long ioctl_code, fuzz_notify_func notify, void* notify_data, int percent_min, int percent_max)
{
	int i = 0, j = 0;
	DWORD fuzz_data = 0;
	int inlen = 0, oulen = 0;
